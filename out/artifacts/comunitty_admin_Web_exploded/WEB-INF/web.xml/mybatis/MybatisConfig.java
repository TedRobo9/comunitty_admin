package com.uacity.admin.config.mybatis;

import com.alibaba.druid.pool.DruidDataSource;
import com.uacity.admin.config.JdbcConnectionSettings;
...
/**
 * Created by Ted on 16/4/26.
 */

@Configuration
@MapperScan(basePackages = "com.uacity.admin.mapper")
public class MybatisConfig {
    ...
    public SqlSessionFactory sqlSessionFactory() throws Exception {
        ...
        sqlSessionFactory.setTypeHandlersPackage("com.uacity.admin.config.mybatis.typehandler");
